...
<div class="container">
<form class="form-searchDestination" action="${ contextPath }/searchList.do" method="post">
<label for="inputDestination" class="sr-only">목적지 검색</label>
    <input type="text" name="dest" id="inputDestination"  class="form-control" placeholder="Destination" required></input>
